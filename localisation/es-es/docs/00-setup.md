...
1. Asegúrate de que tu repositorio bifurcado tenga disponible la pestaña de "Issues". Si no es así, ve a "Settings" 👉 desplázate hacia abajo hasta la sección "Features" 👉 marca la casilla "Issues".
